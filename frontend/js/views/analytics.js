...
function render() {
  ...
  root.appendChild(el('div', { class: 'grid cols-4' },
    ...
    kpi('Production efficiency', o.productionEfficiency ? (o.productionEfficiency.value != null ? pct(o.productionEfficiency.value, 0) : '—') : '—', o.productionEfficiency && o.productionEfficiency.label ? esc(o.productionEfficiency.label) : '', 'good')));
